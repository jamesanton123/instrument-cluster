...
public class Analog3 extends JPanel implements GraphicalJPanel{
	
	private static final long serialVersionUID = 1L;
	private static Analog3 instance;
	...
	private static final Point LOCATION = new Point(InstrumentCluster.LEFT_PANE_SIZE.width, 150);

	public Analog3() {				

	}

	public static Analog3 getInstance() {
		if (instance == null) {
			instance = new Analog3();	
			instance.setProps();
		}
		return instance;
	}
