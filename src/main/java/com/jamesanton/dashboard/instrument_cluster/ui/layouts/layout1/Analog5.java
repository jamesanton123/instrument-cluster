...
public class Analog5 extends JPanel implements GraphicalJPanel{
	...
	private static Analog5 instance;
	...
	private static final Point LOCATION = new Point(InstrumentCluster.LEFT_PANE_SIZE.width, 210);

	public Analog5() {				

	}

	public static Analog5 getInstance() {
		if (instance == null) {
			instance = new Analog5();	
			instance.setProps();
		}
		return instance;
	}
