...
public class Analog1 extends JPanel implements GraphicalJPanel{
	
	private static final long serialVersionUID = 1L;
	private static Analog1 instance;
	...
	private static final Point LOCATION = new Point(InstrumentCluster.LEFT_PANE_SIZE.width, 90);
